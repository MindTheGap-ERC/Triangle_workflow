...
rule matlab:
    ...
    shell:
        "cd src/CarboCATLite;"
        "echo \"CarboCAT_cli('params/DbPlatform/paramsInputValues.txt', 'params/DbPlatform/paramsProcesses.txt', '{wildcards.param_file}', '../../{input}', false); \" | matlab -nodesktop -nosplash;"
